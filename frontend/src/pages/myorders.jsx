import { useState, useEffect } from 'react';
 ...
 const MyOrdersPage = () => {
     ...
     const defaultEmail = 'tanvi@gmail.com';
     ...
     const fetchOrders = async () => {
         try {
             setLoading(true);
             setError('');
             const response = await axios.get('http://localhost:7000/api/v2/orders/myorders', {
     ...
     const cancelOrder = async (orderId) => {
         console.log("aa")
         try {
             const response = await axios.patch(`http://localhost:7000/api/v2/orders/cancel-order/${orderId}`);
